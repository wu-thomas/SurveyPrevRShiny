...
The Github repo maintains the source code for this RShiny application and it is structured as an R package. There are three primary venues to utilize this application:
...
The RShiny app is readily accessible via [https://rsc.stat.washington.edu/surveyPrevRShiny/](https://rsc.stat.washington.edu/surveyPrevRShiny/). The only requirement is a stable internet connection. This web-based deployment supports full functionality and serves as the primary distribution channel.
